...
> GitHub Repository [here](https://github.com/kipu-org/banco-server)
...
1. `git clone https://github.com/kipu-org/banco-server.git`
...
You can build this app using `npm run build`. Or use the [`Dockerfile`](https://github.com/kipu-org/banco-server/blob/main/Dockerfile) to deploy this application.
